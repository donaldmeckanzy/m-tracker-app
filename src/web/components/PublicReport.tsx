...
import { Calendar, Clock, Target, TrendingUp, Coffee } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">Loading productivity report...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center space-y-4 max-w-md">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">Report Not Available</h2>
          ...
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <ul className="text-sm text-gray-600 text-left space-y-1">
              <li>• The report has expired</li>
              <li>• The report was deactivated</li>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4 mb-8">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-blue-100 rounded-full">
            ...
            <span className="text-sm font-medium text-blue-600">Productivity Report</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900">
            {report.user_name || 'Anonymous'}'s Work Day
          </h1>
        ...
        <div className="text-center py-6">
          ...
          <div className="mt-4">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg">
              <TrendingUp className="w-4 h-4" />
              <span>Track your productivity with M-Tracker</span>
            </div>
          </div>
        </div>
      </div>
